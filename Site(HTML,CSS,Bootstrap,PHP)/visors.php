...
<body>
	...
	<?php
      ...
      $query  = "SELECT * FROM products type = 'Козырек' && visible = '1' LIMIT $offset, $limit";
	...
	<nav aria-label="Навигация">
          <ul class="pagination justify-content-center">
            ...
            <li class='"page-item" <?php ($page <= 1 ? print 'disabled' : '')?>'>
              <a class="page-item" href='visors.php?page=1'>В начало</a>
            </li>
            <!-- Links of the pages with page number -->
            <?php for($i=$start; $i<=$end; $i++) { ?>
            <li class='"page-item" <?php ($i == $page ? print 'active' : '')?>'>
              <a class="page-item" href='visors.php?page=<?php echo $i;?>'><?php echo $i;?></a>
            </li>
            <?php } ?>
            <!-- Link of the last page -->
            <li class='"page-item" <?php ($page >= $total_pages ? print 'disabled' : '')?>'>
              <a class="page-item" href='visors.php?page=<?php echo $total_pages;?>'>В конец</a>
            </li>
		  </ul>
	</nav>
       <?php } ?>
