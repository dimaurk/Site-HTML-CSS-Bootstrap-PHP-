...
// определяем начальные данные
   ...
   $sql = "SELECT `Код_заказа`, `Дата_заказа`, `Количество`, `Описание`, `Исполнитель`, `Заказчик`, `Адрес_заказчика` FROM `Заказы` Order by `Дата_заказа` Desc ";
 ...
 // выводим на страницу сайта заголовки HTML-таблицы
  ...
  echo '<thead>';
  echo '<tr>';
  echo '<th>Код_заказа</th>';
  echo '<th>Дата_заказа</th>';
  echo '<th>Количество</th>';
  echo '<th>Описание</th>';
  echo '<th>Исполнитель</th>';
  echo '<th>Заказчик</th>';
  echo '<th>Адрес_заказчика</th>';
  echo '</tr>';
  echo '</thead>';
  echo '<tbody>';
   ...
   while ($data = $result->fetch_assoc()){
    echo '<tr>';
    echo '<td align=center>' . $data['Код_заказа'] . '</td>';
    echo '<td align=center>' . $data['Дата_заказа'] . '</td>';
	echo '<td align=center>' . $data['Количество'] . '</td>';
	echo '<td align=center>' . $data['Описание'] . '</td>';
	echo '<td align=center>' . $data['Исполнитель'] . '</td>';
	echo '<td align=center>' . $data['Заказчик'] . '</td>';
	echo '<td align=center>' . $data['Адрес_заказчика'] . '</td>';
    echo '</tr>';
  }
