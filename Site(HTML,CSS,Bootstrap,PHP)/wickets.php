...
<html>
  ...
  <title>Stolbov - калитки</title>
  <link rel="stylesheet" href="css/bootstrap.min.css">
  <link rel="stylesheet" href="css/font-awesome.min.css">
  <link rel="stylesheet" href="css/main.css">
  <link rel="stylesheet" href="css/wickets_catalog.css">
  </head>
<body>
	...
	<nav aria-label="Навигация">
          <ul class="pagination justify-content-center">
            ...
            <li class='"page-item" <?php ($page <= 1 ? print 'disabled' : '')?>'>
              <a class="page-item" href='wickets.php?page=1'>В начало</a>
            </li>
            <!-- Links of the pages with page number -->
            <?php for($i=$start; $i<=$end; $i++) { ?>
            <li class='"page-item" <?php ($i == $page ? print 'active' : '')?>'>
              <a class="page-item" href='wickets.php?page=<?php echo $i;?>'><?php echo $i;?></a>
            </li>
            <?php } ?>
            <!-- Link of the last page -->
            <li class='"page-item" <?php ($page >= $total_pages ? print 'disabled' : '')?>'>
              <a class="page-item" href='wickets.php?page=<?php echo $total_pages;?>'>В конец</a>
            </li>
		  </ul>
	</nav>
       <?php } ?>
